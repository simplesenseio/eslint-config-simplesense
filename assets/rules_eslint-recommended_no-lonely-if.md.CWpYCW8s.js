import{_ as s,c as i,o as a,a3 as n}from"./chunks/framework.vIlBslkg.js";const g=JSON.parse('{"title":"no-lonely-if","description":"","frontmatter":{"title":"no-lonely-if","rule_type":"suggestion"},"headers":[],"relativePath":"rules/eslint-recommended/no-lonely-if.md","filePath":"rules/eslint-recommended/no-lonely-if.md"}'),l={name:"rules/eslint-recommended/no-lonely-if.md"},e=n(`<p>If an <code>if</code> statement is the only statement in the <code>else</code> block, it is often clearer to use an <code>else if</code> form.</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">if</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (foo) {</span></span>
