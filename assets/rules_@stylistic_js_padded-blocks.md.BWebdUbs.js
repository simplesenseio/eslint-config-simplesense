import{_ as s,c as a,o as i,a3 as n}from"./chunks/framework.vIlBslkg.js";const g=JSON.parse('{"title":"padded-blocks","description":"","frontmatter":{"title":"padded-blocks","rule_type":"layout","related_rules":["lines-between-class-members","padding-line-between-statements"]},"headers":[],"relativePath":"rules/@stylistic/js/padded-blocks.md","filePath":"rules/@stylistic/js/padded-blocks.md"}'),l={name:"rules/@stylistic/js/padded-blocks.md"},p=n(`<h1 id="js-padded-blocks" tabindex="-1">js/padded-blocks <a class="header-anchor" href="#js-padded-blocks" aria-label="Permalink to &quot;js/padded-blocks&quot;">​</a></h1><p>Some style guides require block statements to start and end with blank lines. The goal is to improve readability by visually separating the block content and the surrounding code.</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">if</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (a) {</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">    b</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><p>:::</p><h2 id="when-not-to-use-it" tabindex="-1">When Not To Use It <a class="header-anchor" href="#when-not-to-use-it" aria-label="Permalink to &quot;When Not To Use It&quot;">​</a></h2><p>You can turn this rule off if you are not concerned with the consistency of padding within blocks.</p>`,95),t=[p];function e(h,k,c,o,E,d){return i(),a("div",null,t)}const y=s(l,[["render",e]]);export{g as __pageData,y as default};
